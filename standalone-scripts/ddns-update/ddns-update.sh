...
ZONE_ID="xxxxxxx"                 # Replace with your Cloudflare Zone ID
RECORD_ID="xxxxxx"             # Replace with your DNS Record ID
API_TOKEN="xxxxxx"  # Replace with your Cloudflare API Token
DNS_NAME="xxxxxx"         # Replace with your subdomain (e.g., home.yourdomain.com)
...
if [ "$CURRENT_IP" != "$OLD_IP" ]; then
  ...
  curl -X PUT "https://api.cloudflare.com/client/v4/zones/$ZONE_ID/dns_records/$RECORD_ID" \
    ...
    --data '{"type":"A","name":"'$DNS_NAME'","content":"'$CURRENT_IP'","ttl":1,"proxied":false}'
