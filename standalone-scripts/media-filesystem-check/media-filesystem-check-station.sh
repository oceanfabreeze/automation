...
# Check if /home/familyvids is mounted
if ! mount | grep -q '/home/familyvids'; then
    echo "/home/familyvids is not mounted. Running mount -a..."
    mount -a
    docker_restart_needed=true
fi

# Check if /home/photos is mounted
if ! mount | grep -q '/home/photos'; then
    echo "/home/photos is not mounted. Running mount -a..."
    mount -a
    docker_restart_needed=true
fi
